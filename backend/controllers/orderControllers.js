...
export const newOrder = catchAsyncErros(async (req, res, next) => {
  const {
    orderItems,
    shippingInfo,
    itemsPrice,
...
export const myOrders = catchAsyncErros(async (req, res, next) => {
...
export const getOrderDetails = catchAsyncErros(async (req, res, next) => {
...
export const allOrders = catchAsyncErros(async (req, res, next) => {
...
export const updateOrder = catchAsyncErros(async (req, res, next) => {
...
export const deleteOrder = catchAsyncErros(async (req, res, next) => {
  const order = await Order.findById(req.params.id);
...
export const getSales = catchAsyncErros(async (req, res, next) => {
