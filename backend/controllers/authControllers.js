...
export const registeredUser = catchAsyncErros(async (req, res, next) => {
...
export const logout = catchAsyncErros(async (req, res, next) => {
...
export const uploadAvatar = catchAsyncErros(async (req, res, next) => {
...
export const getUserProfile = catchAsyncErros(async (req, res, next) => {
...
export const updateProfile = catchAsyncErros(async (req, res, next) => {
  const newUserData = {
    name: req.body.name,
...
export const allUsers = catchAsyncErros(async (req, res, next) => {
